...
\begin{document}
\title{\textbf{MelodyShape: a Library and Tool for Symbolic Melodic Similarity based on Shape Similarity\\{\Large Version 1.1}}}
...
JAR packages for both libraries can be downloaded from the Apache Commons project website\footnote{\url{http://commons.apache.org}}. \texttt{MelodyShape} v1.1 was specifically implemented and tested with versions \texttt{commons-cli-1.2} and \texttt{commons-math3-3.2}, also available from the \texttt{MelodyShape} website\footnote{\url{https://github.com/julian-urbano/MelodyShape}}.
...
\begin{lstlisting}
$ ls
commons-cli-1.2.jar    commons-math3-3.2.jar    melodyshape-1.1.jar    data
...
Currently, \texttt{MelodyShape} v1.1 is compiled for Java 7. It can be redistributed and/or modified under the terms of the GNU General Public License version 3.
...
\begin{lstlisting}
$ java -jar melodyshape-1.1.jar -q data/q01.mid -c data/coll/ -a 2010-shape
06C6.mid    0.48583945
1065.mid    0.16715906
07D0.mid    0.15722630
0A5A.mid    0.14412330
...
\begin{lstlisting}
$ java -jar melodyshape-1.1.jar |\underline{-q data/}| -c data/coll/ -a 2010-shape
...
\begin{lstlisting}
$ java -jar melodyshape-1.1.jar -q data/ -c data/coll/ -a 2010-shape |\underline{-k 2}|
q01.mid    06C6.mid    0.48583945
q01.mid    1065.mid    0.16715906
q02.mid    0859.mid    0.44796066
...
\begin{lstlisting}
$ java -jar melodyshape-1.1.jar -q data/ -c data/coll/ -a 2010-shape |\underline{-k 5}| |\underline{-l}|
...
\begin{lstlisting}
$ java -jar melodyshape-1.1.jar -q data/ -c data/coll/ -a 2010-shape -k 5 -l |\underline{-v}|
(1/6) q01.mid...done.
q01.mid    06C6.mid    1065.mid    07D0.mid    0A5A.mid    04D7.mid
(2/6) q02.mid...done.
q02.mid    0859.mid    03FA.mid    0B15.mid    0454.mid    0B2C.mid
...
\begin{lstlisting}
$ java -jar melodyshape-1.1.jar -q data/ -c data/coll/ -a 2010-shape -k 5 -l |\underline{-vv}|
...
\begin{lstlisting}
$ java -jar melodyshape-1.1.jar -q data/ -c data/coll/ -a 2010-shape -l -vv |\underline{> out}|
Reading queries...done (6 melodies).
Reading collection...done (2000 melodies).
Instantiating algorithm...done.
  Comparer: nGram(3,Hybrid(Cache(Freq(BSplineShape(8.0,1.0,0.5)))))
